...
<div class="wpddb-shortcode-item doctor-item posts-item">
    <div class="doctor-thumb">
        ...
        <?php } else {
            ...
            echo '<a href="'. esc_url(get_the_permalink()) .'"><img class="wpddb-media default-media" src="' . esc_url(wpddb()->get_assets_uri('public/img/no-image-570x400.jpg')) . '" alt="'. the_title_attribute( array( 'echo'=> false ) ) .'"/></a>';
        } ?>
    </div>
