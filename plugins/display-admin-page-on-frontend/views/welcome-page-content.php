<p><?php 
_e( 'Thank you for installing our plugin.', VG_Admin_To_Frontend::$textname );
?></p>
...
if ( empty( VG_Admin_To_Frontend_Obj()->allowed_urls ) ) {
    ...
    $allowed_urls_message .= sprintf(
        __( '<h3>Go Premium</h3><p>View ANY admin page in the frontend<br/>View settings pages from the frontend<br/>View WooCommerce settings on the frontend<br/>View WooCommerce stats from the frontend<br/>Install plugins from the frontend<br/>View plugin settings from the frontend<br/>View any page from wp-admin on the frontend<br/>And more.</p><a href="%1$s" class="button button-primary">%2$s</a> - <a href="#tutorial" class="button">Watch a demo video</a> - <a href="%3$s" class="button" target="_blank">Need help? Contact us</a></p><p>Try the plugin without worries.</p><p>Check this video of the premium features.</p><iframe id="tutorial" width="560" height="315" src="https://www.youtube.com/embed/EG1NE3X5yNs?rel=0&amp;controls=0&amp;showinfo=0" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>.', VG_Admin_To_Frontend::$textname ),
        VG_Admin_To_Frontend_Obj()->args['buy_link'],
...
$steps['note'] = '<p>' . __( 'You can read more about advanced settings and configuration following these links: <a href="https://wpfrontendadmin.com/documentation/faq/" target="_blank">FAQs</a>, <a href="https://wpfrontendadmin.com/blog/" target="_blank">Guides</a>, and all <a href="https://wpfrontendadmin.com/courses/" target="_blank">our courses</a>', VG_Admin_To_Frontend::$textname ) . '</p>';
...
<hr>
<h2><?php 
_e( 'Free Courses', VG_Admin_To_Frontend::$textname );
?></h2>
<div class="elementor-text-editor elementor-clearfix">
	<h3><?php 
_e( 'Free Course: Create a Restaurant Management Platform using WordPress', VG_Admin_To_Frontend::$textname );
?>
	</h3>
	<p><?php 
_e( 'In this course, we will show you how to create a platform for restaurants from start to finish, using WordPress Multisite, WP Ultimo, WooCommerce, and WP Frontend Admin.', VG_Admin_To_Frontend::$textname );
?>
	</p>
	<p><?php 
_e( '<b>Restaurants will pay you a monthly fee</b> and they will be able to sell meals, manage orders, create a QR code, and have a beautiful digital menu for their restaurant.', VG_Admin_To_Frontend::$textname );
?>
	</p>
	<a href="
	<?php 
echo esc_url( __( 'https://wpfrontendadmin.com/restaurant-management-platform/', VG_Admin_To_Frontend::$textname ) );
?>
	" target="_blank" rel="noopener"
		class="button button-primary"><?php 
_e( 'Sign up for FREE', VG_Admin_To_Frontend::$textname );
?></a>
</div>
<hr>
<div class="elementor-text-editor elementor-clearfix">
	<h2><?php 
_e( 'Free Course: Create a Platform like Shopify', VG_Admin_To_Frontend::$textname );
?></h2>
	<p><?php 
_e( 'In this course, we will show you how to create a platform like Shopify from start to finish, using WordPress Multisite, WP Ultimo, WooCommerce, and WP Frontend Admin.', VG_Admin_To_Frontend::$textname );
?>
	</p>
	<p>
		<?php 
_e( '<b>Charge a monthly fee for each store created in your</b>&nbsp;
		<strong>platform</strong> and start making money.', VG_Admin_To_Frontend::$textname );
?>
	</p>
	<a href="
	<?php 
echo esc_url( __( 'https://wpfrontendadmin.com/how-to-create-a-platform-like-shopify/', VG_Admin_To_Frontend::$textname ) );
?>
	" target="_blank" rel="noopener"
		class="button button-primary"><?php 
_e( 'Sign up for FREE', VG_Admin_To_Frontend::$textname );
...
<div class="elementor-text-editor elementor-clearfix">
	<h2><?php 
_e( 'Free Course: Create a Donations/Crowdfunding Platform', VG_Admin_To_Frontend::$textname );
?></h2>
	<p><?php 
_e( 'In this course, we will show you how to build a fundraising platform that will allow your users to collect donations, manage donor profiles, view collected donations, set up payment gateways, etc.', VG_Admin_To_Frontend::$textname );
?>
	</p>
	<p><?php 
_e( '<b>Charge a monthly fee</b> for each nonprofit that uses your platform and start making money.', VG_Admin_To_Frontend::$textname );
?>
	</p>
	<a href="
	<?php 
echo esc_url( __( 'https://wpfrontendadmin.com/givewp-donations-platform/', VG_Admin_To_Frontend::$textname ) );
?>
	" target="_blank" rel="noopener"
		class="button button-primary"><?php 
_e( 'Sign up for FREE', VG_Admin_To_Frontend::$textname );
...
?>
<script>
jQuery('.vg-logo').parent().attr('href',
	'https://wpfrontendadmin.com/?utm_source=wp-admin&utm_campaign=logo&utm_medium=welcome-page')
